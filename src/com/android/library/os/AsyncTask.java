package com.android.library.os;
...
public abstract class AsyncTask<Params, Progress, Result> {
     ...
     */
    public static final Executor                 SERIAL_EXECUTOR       = VersionUtils.hasHoneycomb() ? new SerialExecutor() : Executors.newSingleThreadExecutor(sThreadFactory);

    public static final Executor                 DUAL_THREAD_EXECUTOR  = Executors.newFixedThreadPool(30, sThreadFactory);
